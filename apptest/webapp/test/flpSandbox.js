		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Test",
									"targetURL": "#cltestapptest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cltestapptest-display": {
								"semanticObject": "cltestapptest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl.test.apptest",
									"url": sap.ui.require.toUrl("cl/test/apptest")
								}
							}
						}
					}
